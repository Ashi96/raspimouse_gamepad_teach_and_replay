...
void Episodes::coordinatetransformation(void)
{
  ...
  constexpr double crf = cos(3 * 3.141592 / 180.0);*/
	...
	//vector<float> right_angle = {13, 40, 67, 93, 120};
	//vector<float> left_angle = {13, 40, 67, 93, 120};
	//vector<float> right_angle = {3, 15, 20, 30, 40, 45, 60, 75, 90, 120};
	//vector<float> left_angle = {3, 15, 20, 30, 40, 45, 60, 75, 90, 120};
	//vector<float> right_angle = {2, 5, 9, 12, 16, 19, 23, 26, 30, 33, 37, 40, 43, 47, 50, 54, 57, 61, 64, 68, 71, 75, 78, 82, 85, 89, 92, 96, 99, 103, 106, 110, 113, 117, 120};
	//vector<float> left_angle = {2, 5, 9, 12, 16, 19, 23, 26, 30, 33, 37, 40, 43, 47, 50, 54, 57, 61, 64, 68, 71, 75, 78, 82, 85, 89, 92, 96, 99, 103, 106, 110, 113, 117, 120};
	vector<float> right_angle = {2, 5, 8, 11, 14, 17, 20, 23, 26, 29, 32, 35, 38, 41, 44, 47, 50, 53, 56, 59, 62, 65, 68, 71, 74, 77, 81, 84, 87, 90, 93, 96, 99, 102, 105, 108, 111, 114, 117, 120};
	vector<float> left_angle = {2, 5, 8, 11, 14, 17, 20, 23, 26, 29, 32, 35, 38, 41, 44, 47, 50, 53, 56, 59, 62, 65, 68, 71, 74, 77, 81, 84, 87, 90, 93, 96, 99, 102, 105, 108, 111, 114, 117, 120};
	//vector<float> right_angle = {1, 3, 5, 7, 9, 11, 13.1, 15.1, 17.1, 19.2, 21.2, 23.2, 25.2, 27.2, 29.2, 31.3, 33.3, 35.3, 37.3, 39.3, 41.3, 43.4, 45.4, 47.4, 49.4, 51.4, 53.4, 55.5, 57.5, 59.5, 61.5, 63.5, 65.5, 67.6, 70, 71.6, 73.6, 75.6, 77.6, 79.7, 81.7, 83.7, 85.7, 87.7, 89.7, 91.8, 93.8, 95.8, 97.8, 99.8, 101.8, 103.9, 105.9, 107.9, 109.9, 111.9, 113.9, 116, 118, 120};
	//vector<float> left_angle = {1, 3, 5, 7, 9, 11, 13.1, 15.1, 17.1, 19.2, 21.2, 23.2, 25.2, 27.2, 29.2, 31.3, 33.3, 35.3, 37.3, 39.3, 41.3, 43.4, 45.4, 47.4, 49.4, 51.4, 53.4, 55.5, 57.5, 59.5, 61.5, 63.5, 65.5, 67.6, 70, 71.6, 73.6, 75.6, 77.6, 79.7, 81.7, 83.7, 85.7, 87.7, 89.7, 91.8, 93.8, 95.8, 97.8, 99.8, 101.8, 103.9, 105.9, 107.9, 109.9, 111.9, 113.9, 116, 118, 120};
